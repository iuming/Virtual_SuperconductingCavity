...
/* Generated from ../O.Common/myexample.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devmyexampleVersion, *pvar_dset_devLsoSoft,
...
static const char * const deviceSupportNames[] = {
    ...
    "devLoSoftCallback", "devLsiSoft", "devLsiEnviron",
    "devmyexampleVersion", "devLsoSoft", "devLsoSoftCallback",
    ...
    "devSoStdio", "devSASoft", "devWfSoft", "devWfPDBDemo", "devXxxSoft"
};
...
int myexample_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/training/Desktop/myexample";
...
/* myexample_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"myexample_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(myexample_registerRecordDeviceDriver(*iocshPpdbbase));
}
